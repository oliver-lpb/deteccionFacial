...
export class UploadComponent implements OnInit {
  ...
  processFace = async (image:any, imageContainer:any)=>{
    ...
    if(typeof detection == 'undefined'){
      imageContainer.querySelector('.status').innerText = 'No se puedo Procesar la imagen';
      ...
      imageContainer.querySelector('.status').innerText='Precesado';
      imageContainer.querySelector('.status').style.color = 'green';
      this.onSubmit();
  ...
  eliminar(id:any,nombreImagen:string){
    Swal.fire({
      icon:'question',
      title:'Desea elimianr el registro?',
      showCancelButton:true,
